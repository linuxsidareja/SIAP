...
[wxID_KEJADIAN_PINDAH, wxID_KEJADIAN_PINDAHCARI_KK, 
 ...
 wxID_KEJADIAN_PINDAHLABEL_ALAMAT, wxID_KEJADIAN_PINDAHLABEL_DIFABELITAS, 
 wxID_KEJADIAN_PINDAHLABEL_DUSUN, wxID_KEJADIAN_PINDAHLABEL_GOLONGAN_DARAH, 
...
class kejadian_pindah(wx.Frame):
    ...
    def _init_ctrls(self, prnt):
        # generated method, don't edit
        wx.Frame.__init__(self, id=wxID_KEJADIAN_PINDAH,
              name=u'edit_kejadian_pindah', parent=prnt, pos=wx.Point(420, 99),
              size=wx.Size(896, 669), style=wx.DEFAULT_FRAME_STYLE,
    ...
    def IsiList(self):    
        ...
        sql = "SELECT * FROM penduduk WHERE kematian='Tidak' AND pindah=''"
        cur.execute(sql) 
        hasil = cur.fetchall() 
    ...
    def OnTombol_tambah_dataButton(self, event):
        ...
        if laporan == '':
            ...
            self.pesan = wx.MessageDialog(self,"Keterangan Pindah Jangan Kosong","Peringatan",wx.OK) 
            self.pesan.ShowModal()    
