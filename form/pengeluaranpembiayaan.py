#Boa:Frame:pengeluaranpembiayaan
#-------------------------------------------------------------------------------
...
def create(parent):
    return pengeluaranpembiayaan(parent)

[wxID_PENGELUARANPEMBIAYAAN, wxID_PENGELUARANPEMBIAYAANASLIDESA, 
 wxID_PENGELUARANPEMBIAYAANBUTTON1, wxID_PENGELUARANPEMBIAYAANCARINOREK, 
 wxID_PENGELUARANPEMBIAYAANEDIT, wxID_PENGELUARANPEMBIAYAANKEGIATAN, 
 wxID_PENGELUARANPEMBIAYAANMENU, wxID_PENGELUARANPEMBIAYAANNOINDEX, 
 wxID_PENGELUARANPEMBIAYAANNOREK, wxID_PENGELUARANPEMBIAYAANPEMBANGUNANDESA, 
 wxID_PENGELUARANPEMBIAYAANPEMBIAYAAN, wxID_PENGELUARANPEMBIAYAANREKENING, 
 wxID_PENGELUARANPEMBIAYAANSTATICBOX1, wxID_PENGELUARANPEMBIAYAANSTATICTEXT2, 
 wxID_PENGELUARANPEMBIAYAANSTATICTEXT3, wxID_PENGELUARANPEMBIAYAANTAMBAH, 
] = [wx.NewId() for _init_ctrls in range(16)]

class pengeluaranpembiayaan(wx.Frame):
    ...
    def _init_ctrls(self, prnt):
        # generated method, don't edit
        wx.Frame.__init__(self, id=wxID_PENGELUARANPEMBIAYAAN,
              name=u'pengeluaranpembiayaan', parent=prnt, pos=wx.Point(561,
              213), size=wx.Size(615, 437), style=wx.DEFAULT_FRAME_STYLE,
              title=u'Master Pengeluaran Pembiayaan')
        self.SetClientSize(wx.Size(607, 407))
        self.SetAutoLayout(False)
        self.Center(wx.BOTH)
        self.SetBackgroundColour(wx.Colour(192, 192, 192))

        self.pembangunandesa = wx.ListCtrl(id=wxID_PENGELUARANPEMBIAYAANPEMBANGUNANDESA,
        ...
        self.pembangunandesa.Bind(wx.EVT_LIST_ITEM_SELECTED,
              ...
              id=wxID_PENGELUARANPEMBIAYAANPEMBANGUNANDESA)

        self.pembiayaan = wx.StaticText(id=wxID_PENGELUARANPEMBIAYAANPEMBIAYAAN,
        ...
        self.aslidesa = wx.StaticText(id=wxID_PENGELUARANPEMBIAYAANASLIDESA,
              label=u'3.2. Pengeluaran Pembiayaan', name=u'aslidesa',
              parent=self, pos=wx.Point(8, 24), size=wx.Size(167, 13), style=0)
        self.aslidesa.SetFont(wx.Font(8, wx.SWISS, wx.NORMAL, wx.BOLD, False,
              u'Tahoma'))

        self.staticText2 = wx.StaticText(id=wxID_PENGELUARANPEMBIAYAANSTATICTEXT2,
              label=u'Nomor Rekening', name='staticText2', parent=self,
              pos=wx.Point(8, 328), size=wx.Size(79, 13), style=0)

        self.norek = wx.TextCtrl(id=wxID_PENGELUARANPEMBIAYAANNOREK,
              name=u'norek', parent=self, pos=wx.Point(96, 328),
              size=wx.Size(48, 21), style=0, value=u'')

        self.staticText3 = wx.StaticText(id=wxID_PENGELUARANPEMBIAYAANSTATICTEXT3,
              label=u'Kegiatan', name='staticText3', parent=self,
              pos=wx.Point(152, 328), size=wx.Size(43, 13), style=0)

        self.kegiatan = wx.TextCtrl(id=wxID_PENGELUARANPEMBIAYAANKEGIATAN,
              name=u'kegiatan', parent=self, pos=wx.Point(208, 328),
              size=wx.Size(392, 21), style=0, value=u'')

        self.tambah = wx.Button(id=wxID_PENGELUARANPEMBIAYAANTAMBAH,
        ...
        self.tambah.Bind(wx.EVT_BUTTON, self.OnTambahButton,
              id=wxID_PENGELUARANPEMBIAYAANTAMBAH)

        self.edit = wx.Button(id=wxID_PENGELUARANPEMBIAYAANEDIT,
        ...
        self.edit.Bind(wx.EVT_BUTTON, self.OnEditButton,
              id=wxID_PENGELUARANPEMBIAYAANEDIT)

        self.menu = wx.Button(id=wxID_PENGELUARANPEMBIAYAANMENU,
        ...
        self.menu.Bind(wx.EVT_BUTTON, self.OnMenuButton,
              id=wxID_PENGELUARANPEMBIAYAANMENU)

        self.staticBox1 = wx.StaticBox(id=wxID_PENGELUARANPEMBIAYAANSTATICBOX1,
              label=u'Cari Norek', name='staticBox1', parent=self,
              pos=wx.Point(8, 352), size=wx.Size(181, 48), style=0)

        self.rekening = wx.Button(id=wxID_PENGELUARANPEMBIAYAANREKENING,
        ...
        self.rekening.Bind(wx.EVT_BUTTON, self.OnRekeningButton,
              id=wxID_PENGELUARANPEMBIAYAANREKENING)

        self.carinorek = wx.TextCtrl(id=wxID_PENGELUARANPEMBIAYAANCARINOREK,
              name=u'carinorek', parent=self, pos=wx.Point(96, 368),
              size=wx.Size(84, 21), style=0, value=u'')

        self.noindex = wx.TextCtrl(id=wxID_PENGELUARANPEMBIAYAANNOINDEX,
              name=u'noindex', parent=self, pos=wx.Point(-100, -100),
              size=wx.Size(100, 21), style=0, value=u'')

        self.button1 = wx.Button(id=wxID_PENGELUARANPEMBIAYAANBUTTON1,
              label=u'Hapus Data', name='button1', parent=self,
              pos=wx.Point(403, 368), size=wx.Size(75, 23), style=0)
        self.button1.Bind(wx.EVT_BUTTON, self.OnButton1Button,
              id=wxID_PENGELUARANPEMBIAYAANBUTTON1)
    ...
    def IsiList(self): 
        ...
        sql = "SELECT * FROM koderek WHERE kode='3.2'"
        cur.execute(sql) 
        hasil = cur.fetchall() 
    ...
    def OnTambahButton(self, event):
        ...
        if nomorrekening == '':
            ...
            if hasil:
                ...
                add_rekening="INSERT INTO koderek (kode, norek ,kegiatan ) VALUES('3.2','"+(nomorrekening)+"', '"+(namakegiatan)+"')"        
