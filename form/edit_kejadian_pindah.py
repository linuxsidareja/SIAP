...
[wxID_EDIT_KEJADIAN_PINDAH, wxID_EDIT_KEJADIAN_PINDAHCARI_KK, 
 wxID_EDIT_KEJADIAN_PINDAHDOKUMEN, wxID_EDIT_KEJADIAN_PINDAHHAPUS, 
 wxID_EDIT_KEJADIAN_PINDAHINPUTNO, wxID_EDIT_KEJADIAN_PINDAHINPUT_ALAMAT, 
 wxID_EDIT_KEJADIAN_PINDAHINPUT_AYAH, wxID_EDIT_KEJADIAN_PINDAHINPUT_DUSUN, 
 wxID_EDIT_KEJADIAN_PINDAHINPUT_IBU, wxID_EDIT_KEJADIAN_PINDAHINPUT_NAMA, 
 wxID_EDIT_KEJADIAN_PINDAHINPUT_NIK, wxID_EDIT_KEJADIAN_PINDAHINPUT_NO, 
 wxID_EDIT_KEJADIAN_PINDAHINPUT_NO_KK, wxID_EDIT_KEJADIAN_PINDAHINPUT_RT, 
 wxID_EDIT_KEJADIAN_PINDAHINPUT_RW, 
 ...
 wxID_EDIT_KEJADIAN_PINDAHNAMA_KK, wxID_EDIT_KEJADIAN_PINDAHNO, 
 wxID_EDIT_KEJADIAN_PINDAHPILIHAN_AGAMA, 
...
class edit_kejadian_pindah(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.hapus = wx.Button(id=wxID_EDIT_KEJADIAN_PINDAHHAPUS,
        ...
        self.hapus.Bind(wx.EVT_BUTTON, self.OnHapusButton,
              id=wxID_EDIT_KEJADIAN_PINDAHHAPUS)

        self.no = wx.TextCtrl(id=wxID_EDIT_KEJADIAN_PINDAHNO, name=u'nor',
              parent=self, pos=wx.Point(-120, -128), size=wx.Size(100, 21),
              style=0, value=u'')
