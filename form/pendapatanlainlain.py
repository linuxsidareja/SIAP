...
[wxID_MASTERDATA, wxID_MASTERDATABUTTON1, wxID_MASTERDATACARINOREK, 
 ...
 wxID_MASTERDATAPENDAPATAN, wxID_MASTERDATAPENDAPATANLAIN, 
...
class masterdata(wx.Frame):
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(self, id=wxID_MASTERDATA, name=u'masterdata',
              ...
              title=u'Master Pendapatan Lain-lain')
        ...
        self.pendapatanlain = wx.StaticText(id=wxID_MASTERDATAPENDAPATANLAIN,
              label=u'1.3. Pendapatan Lain-lain', name=u'pendapatanlain',
              parent=self, pos=wx.Point(8, 24), size=wx.Size(142, 13), style=0)
        self.pendapatanlain.SetFont(wx.Font(8, wx.SWISS, wx.NORMAL, wx.BOLD,
              False, u'Tahoma'))
    ...
    def IsiList(self): 
        ...
        sql = "SELECT * FROM koderek WHERE kode='1.3'"
        cur.execute(sql) 
        hasil = cur.fetchall() 
    ...
    def OnTambahButton(self, event):
        ...
        if nomorrekening == '':
            ...
            if hasil:
                ...
                add_rekening="INSERT INTO koderek (kode, norek ,kegiatan ) VALUES('1.3','"+(nomorrekening)+"', '"+(namakegiatan)+"')"        
