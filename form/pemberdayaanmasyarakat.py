...
[wxID_MASTERDATA, wxID_MASTERDATAASLIDESA, wxID_MASTERDATABUTTON1, 
 wxID_MASTERDATACARINOREK, wxID_MASTERDATAEDIT, wxID_MASTERDATAKEGIATAN, 
...
class masterdata(wx.Frame):
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(self, id=wxID_MASTERDATA, name=u'masterdata',
              ...
              title=u'Master Bidang Pemberdayaan Masyarakat')
        ...
        self.aslidesa = wx.StaticText(id=wxID_MASTERDATAASLIDESA,
              label=u'2.4. Pemberdayaan Masyarakat', name=u'aslidesa',
              parent=self, pos=wx.Point(8, 24), size=wx.Size(180, 13), style=0)
    ...
    def OnTambahButton(self, event):
        ...
        if nomorrekening == '':
            ...
            if hasil:
                ...
                add_rekening="INSERT INTO koderek (kode, norek ,kegiatan ) VALUES('2.4','"+(nomorrekening)+"', '"+(namakegiatan)+"')"        
