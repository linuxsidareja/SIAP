...
[wxID_APBDESA, wxID_APBDESAANGGARAN, wxID_APBDESABUTTON1, wxID_APBDESAEDIT, 
 ...
 wxID_APBDESALISTRKP, wxID_APBDESAMENU, wxID_APBDESANOMOR, wxID_APBDESANOREK, 
 wxID_APBDESAPERIODE, wxID_APBDESARKP, wxID_APBDESASTATICTEXT1, 
...
class apbdesa(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(self, id=wxID_APBDESA, name=u'apbdesa', parent=prnt,
              pos=wx.Point(527, 172), size=wx.Size(682, 520),
              style=wx.DEFAULT_FRAME_STYLE, title=u'Penyusunan APB Desa')
        self.SetClientSize(wx.Size(674, 490))
        self.Center(wx.BOTH)
        ...
        self.listapbdes = wx.ListCtrl(id=wxID_APBDESALISTAPBDES,
              ...
              size=wx.Size(666, 227), style=wx.LC_REPORT)
        ...
        self.button1 = wx.Button(id=wxID_APBDESABUTTON1, label=u'Buat APBDesa',
              name='button1', parent=self, pos=wx.Point(567, 4),
        ...
        self.tambah = wx.Button(id=wxID_APBDESATAMBAH, label=u'Tambah Data',
              name=u'tambah', parent=self, pos=wx.Point(301, 230),
        ...
        self.edit = wx.Button(id=wxID_APBDESAEDIT, label=u'Edit Data',
              name=u'edit', parent=self, pos=wx.Point(395, 230),
        ...
        self.hapus = wx.Button(id=wxID_APBDESAHAPUS, label=u'Hapus Data',
              name=u'hapus', parent=self, pos=wx.Point(490, 230),
        ...
        self.menu = wx.Button(id=wxID_APBDESAMENU, label=u'Ke Menu',
              name=u'menu', parent=self, pos=wx.Point(592, 230),
        ...
        self.periode = wx.TextCtrl(id=wxID_APBDESAPERIODE, name=u'periode',
              parent=self, pos=wx.Point(396, 4), size=wx.Size(72, 21), style=0,
              value=u'')

        self.rkp = wx.ComboBox(choices=['1', '2', '3', '4', '5', '6'],
              id=wxID_APBDESARKP, name=u'rkp', parent=self, pos=wx.Point(520,
        ...
        self.uraian = wx.TextCtrl(id=wxID_APBDESAURAIAN, name=u'uraian',
              parent=self, pos=wx.Point(395, 104), size=wx.Size(272, 48),
    ...
    def OnEditButton(self, event):
        self.pesan = wx.MessageDialog(self,"Tidak Bisa Mengedit Disini \n Silahkan Anda Edit Pada Bagian RKP","Konfirmasi",wx.OK) 
    ...
    def OnTambahButton(self, event):
        ...
        sql1 = "INSERT INTO apbdes (norek,uraian,anggaran,keterangan,id_rkp,periode,tahun) VALUES ('"+(rnorek)+"','"+(ruraian)+"','"+(ranggaran)+"','"+(rketerangan)+"','"+(rrkp)+"','"+(rperiode)+"','"+(rtahun)+"')"
        cur.execute(sql1) 
        sql2 = "UPDATE rkpsid SET cekapbdes='0' WHERE no='"+rnomor+"'"
        cur.execute(sql2) 
        db.commit()
