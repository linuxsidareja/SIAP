...
[wxID_MASTERDATA, wxID_MASTERDATAASLIDESA, wxID_MASTERDATACARINOREK, 
 wxID_MASTERDATAEDIT, wxID_MASTERDATAHAPUS, wxID_MASTERDATAKEGIATAN, 
 wxID_MASTERDATAMENU, wxID_MASTERDATANOINDEX, wxID_MASTERDATANOREK, 
 wxID_MASTERDATAPEMBANGUNANDESA, wxID_MASTERDATAPENDAPATAN, 
...
class masterdata(wx.Frame):
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(self, id=wxID_MASTERDATA, name=u'masterdata',
              ...
              title=u'Master Pendapatan Asli Desa')
        ...
        self.aslidesa = wx.StaticText(id=wxID_MASTERDATAASLIDESA,
              label=u'1.1. Pendapatan Asli Desa', name=u'aslidesa', parent=self,
        ...
        self.hapus = wx.Button(id=wxID_MASTERDATAHAPUS, label=u'Hapus Data',
              name=u'hapus', parent=self, pos=wx.Point(403, 368),
              size=wx.Size(75, 23), style=0)
        self.hapus.Bind(wx.EVT_BUTTON, self.OnHapusButton,
              id=wxID_MASTERDATAHAPUS)
    ...
    def IsiList(self): 
        ...
        sql = "SELECT * FROM koderek WHERE kode='1.1'"
        cur.execute(sql) 
        hasil = cur.fetchall() 
    ...
    def OnTambahButton(self, event):
        ...
        if nomorrekening == '':
            ...
            if hasil:
                ...
                add_rekening="INSERT INTO koderek (kode, norek ,kegiatan ) VALUES('1.1','"+(nomorrekening)+"', '"+(namakegiatan)+"')"        
